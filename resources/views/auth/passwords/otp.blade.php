    ...
    <div class="row justify-content-center">
        <div class="col-8 box" style="margin-top:10%;min-height:350px;background-image:url('{{URL::asset('storage/images/bg/login6.jpg')}}');background-size:cover; background-repeat:no-repeat">
                    <div class="row" >
                        ...
                        @endif -->
                            <form action="{{ url('/reset/otp') }}" method="POST" > 
                            @csrf
                                <h5>One-Time PIN</h5>
                                <p>For protection, please enter the One-Time PIN that has been sent to <strong>{{ $recipient }}</strong>.
                                ...
                                <div class="form-group mt-3">    
                                    <input type="text" class="form-control form-control-lg @error('otp') is-invalid @enderror"
                                           ...
                                           maxlength="6"
                                           style="opacity:.9">
                                    <input type="hidden" id="crypt_e" name="crypt_e" value="{{ encrypt($recipient) }}">
                                ...
                                <button type="button" id="resend_reset_otp" class="btn btn-outline-dark">Resend OTP via email</button>
